...
"0                                      w                                            w                                                                0",
"0                                                                                                                                                    0",
"0                      c                                                                     rrrrrrr      r       r        rrrrrrr   rrrrr  rrrrrr   0",
"0                                                                       r   r                   r       r   r   r   r      r     r   r   r  r    r   0",
"0                                                                      rr   rr                  r      r      r       r    r     r   r   r  r    r   0",
"0                                                                     rrr   rrr                 r       r            r     rrrrrrr   rrrrr  r    r   0",
"0               c    kckck                                           rrrr   rrrr                r         r        r       r     r      rr  r    r   0",
"0                                      t0                           rrrrr   rrrrr            rrrrrrr        r    r         r     r    r  r  r    r   0",
"0G                                     00              t0          rrrrrr   rrrrrr       G                    r                                      0",
"0           d    g       d             00              00         rrrrrrr   rrrrrrr                                                                  0",
...
public:
	...
	float dx, dy; /// перемещение
	FloatRect rect; // ширина и высота
	bool onGround;
	Sprite sprite;
	float currentFrame;
...
int main()
{
	...
	RenderWindow window(VideoMode(400, 250), "My first Mario! Malinovskiy Alexey");
